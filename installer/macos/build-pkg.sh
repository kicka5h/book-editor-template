#!/bin/bash
# build-pkg.sh — Builds a macOS .pkg installer for Beckit
# Usage: bash installer/macos/build-pkg.sh <VERSION>
# Expects: dist/Beckit.app to exist (output of flet pack)
# Produces: dist/Beckit-macOS-<VERSION>.pkg
set -euo pipefail
...
APP_SOURCE="$REPO_ROOT/dist/Beckit.app"
PKG_ROOT="$REPO_ROOT/build/pkg-root"
SCRIPTS_DIR="$SCRIPT_DIR/scripts"
COMPONENT_PKG="$REPO_ROOT/build/Beckit-component.pkg"
BUILD_DIR="$REPO_ROOT/build"
FINAL_PKG="$REPO_ROOT/dist/Beckit-macOS-${VERSION}.pkg"

echo "==> Building Beckit macOS PKG v${VERSION}"
...
cp -R "$APP_SOURCE" "$PKG_ROOT/Applications/Beckit.app"
...
<installer-gui-script minSpecVersion="2">
    <title>Beckit ${VERSION}</title>
    <organization>com.beckit</organization>
    ...
    <choices-outline>
        <line choice="default">
            <line choice="com.beckit.app"/>
        </line>
    </choices-outline>
    <choice id="default"/>
    <choice id="com.beckit.app" visible="false">
        <pkg-ref id="com.beckit.app"/>
    </choice>
    <pkg-ref id="com.beckit.app" version="${VERSION}" onConclusion="none">Beckit-component.pkg</pkg-ref>
...
<!DOCTYPE html>
<html><body>
<h2>Welcome to Beckit</h2>
<p>This installer will install <strong>Beckit</strong> into your Applications folder.</p>
...
<p><strong>Beckit</strong> has been installed to your Applications folder.</p>
...
<p>Launch <strong>Beckit</strong> from your Applications folder or Launchpad.</p>
</body></html>
CONCLUSION
